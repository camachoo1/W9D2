...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _moveError__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./moveError */ \"./ttt_node/moveError.js\");\n\n\nclass Board {\n  constructor() {\n    this.grid = Board.makeGrid();\n  }\n\n  isEmptyPos(pos) {\n    if (!Board.isValidPos(pos)) {\n      throw new _moveError__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Is not valid position!');\n    }\n\n    return this.grid[pos[0]][pos[1]] === null;\n  }\n\n  isOver() {\n    if (this.winner() != null) {\n      return true;\n    }\n\n    for (let rowIdx = 0; rowIdx < 3; rowIdx++) {\n      for (let colIdx = 0; colIdx < 3; colIdx++) {\n        if (this.isEmptyPos([rowIdx, colIdx])) {\n          return false;\n        }\n      }\n    }\n\n    return true;\n  }\n\n  placeMark(pos, mark) {\n    if (!this.isEmptyPos(pos)) {\n      throw new _moveError__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Is not an empty position!');\n    }\n\n    this.grid[pos[0]][pos[1]] = mark;\n  }\n\n  print() {\n    const strs = [];\n    for (let rowIdx = 0; rowIdx < 3; rowIdx++) {\n      const marks = [];\n      for (let colIdx = 0; colIdx < 3; colIdx++) {\n        marks.push(\n          this.grid[rowIdx][colIdx] ? this.grid[rowIdx][colIdx] : ' '\n        );\n      }\n      strs.push(`${marks.join('|')}\\n`);\n    }\n\n    console.log(strs.join('-----\\n'));\n  }\n\n  winner() {\n    const posSeqs = [\n      // horizontals\n      [\n        [0, 0],\n        [0, 1],\n        [0, 2],\n      ],\n      [\n        [1, 0],\n        [1, 1],\n        [1, 2],\n      ],\n      [\n        [2, 0],\n        [2, 1],\n        [2, 2],\n      ],\n      // verticals\n      [\n        [0, 0],\n        [1, 0],\n        [2, 0],\n      ],\n      [\n        [0, 1],\n        [1, 1],\n        [2, 1],\n      ],\n      [\n        [0, 2],\n        [1, 2],\n        [2, 2],\n      ],\n      // diagonals\n      [\n        [0, 0],\n        [1, 1],\n        [2, 2],\n      ],\n      [\n        [2, 0],\n        [1, 1],\n        [0, 2],\n      ],\n    ];\n\n    for (let i = 0; i < posSeqs.length; i++) {\n      const winner = this.winnerHelper(posSeqs[i]);\n      if (winner != null) {\n        return winner;\n      }\n    }\n\n    return null;\n  }\n\n  winnerHelper(posSeq) {\n    for (let markIdx = 0; markIdx < Board.MARKS.length; markIdx++) {\n      const targetMark = Board.MARKS[markIdx];\n      let winner = true;\n      for (let posIdx = 0; posIdx < 3; posIdx++) {\n        const pos = posSeq[posIdx];\n        const mark = this.grid[pos[0]][pos[1]];\n\n        if (mark != targetMark) {\n          winner = false;\n        }\n      }\n\n      if (winner) {\n        return targetMark;\n      }\n    }\n\n    return null;\n  }\n\n  static isValidPos(pos) {\n    return 0 <= pos[0] && pos[0] < 3 && 0 <= pos[1] && pos[1] < 3;\n  }\n\n  static makeGrid() {\n    const grid = [];\n\n    for (let i = 0; i < 3; i++) {\n      grid.push([]);\n      for (let j = 0; j < 3; j++) {\n        grid[i].push(null);\n      }\n    }\n\n    return grid;\n  }\n  static MARKS = ['x', 'o'];\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Board);\n\n\n//# sourceURL=webpack:///./ttt_node/board.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _board__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./board */ \"./ttt_node/board.js\");\n/* harmony import */ var _moveError__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./moveError */ \"./ttt_node/moveError.js\");\n\n\n\nclass Game {\n  constructor() {\n    this.board = new _board__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n    this.currentPlayer = _board__WEBPACK_IMPORTED_MODULE_0__[\"default\"].MARKS[0];\n    // this.mark = this.currentPlayer.bind(this)\n  }\n\n  isOver() {\n    return this.board.isOver();\n  }\n\n  playMove(pos) {\n    this.board.placeMark(pos, this.currentPlayer);\n    this.swapTurn();\n  }\n\n  promptMove(reader, callback) {\n    const game = this;\n\n    this.board.print();\n    console.log(`Current Turn: ${this.currentPlayer}`);\n\n    reader.question('Enter rowIdx: ', (rowIdxStr) => {\n      const rowIdx = parseInt(rowIdxStr);\n      reader.question('Enter colIdx: ', (colIdxStr) => {\n        const colIdx = parseInt(colIdxStr);\n        callback([rowIdx, colIdx]);\n      });\n    });\n  }\n\n  run(reader, gameCompletionCallback) {\n    this.promptMove(reader, (move) => {\n      try {\n        this.playMove(move);\n      } catch (e) {\n        if (e instanceof _moveError__WEBPACK_IMPORTED_MODULE_1__[\"default\"]) {\n          console.log(e.msg);\n        } else {\n          throw e;\n        }\n      }\n\n      if (this.isOver()) {\n        this.board.print();\n        if (this.winner()) {\n          console.log(`${this.winner()} has won!`);\n        } else {\n          console.log('NO ONE WINS!');\n        }\n        gameCompletionCallback();\n      } else {\n        // continue loop\n        this.run(reader, gameCompletionCallback);\n      }\n    });\n  }\n\n  swapTurn() {\n    if (this.currentPlayer === _board__WEBPACK_IMPORTED_MODULE_0__[\"default\"].MARKS[0]) {\n      this.currentPlayer = _board__WEBPACK_IMPORTED_MODULE_0__[\"default\"].MARKS[1];\n    } else {\n      this.currentPlayer = _board__WEBPACK_IMPORTED_MODULE_0__[\"default\"].MARKS[0];\n    }\n  }\n\n  winner() {\n    return this.board.winner();\n  }\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Game);\n\n\n//# sourceURL=webpack:///./ttt_node/game.js?");
